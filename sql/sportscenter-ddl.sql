...
select * from tb_qna tq where qna_no = 30;

update tb_qna set incount = (select incount from tb_qna where qna_no = 1) + 1 where qna_no = 1;

alter table tb_qna drop column `QNA_ANSWER`;
